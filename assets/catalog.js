...
(function () {
  ...
  var GROUPS = [
    { id: 'ready', title: 'Готовые решения', mobile: 'Готовые', icon: 'ready', chipImg: 'icons/group-ready.png?v=6', note: 'Композиции для любого повода' },
    { id: 'characters', title: 'Персонажи', mobile: 'Персонажи', icon: 'characters', chipImg: 'icons/group-characters.png?v=6', note: 'Любимые герои детей' },
    { id: 'unit', title: 'Шары поштучно', mobile: 'Шары', icon: 'unit', chipImg: 'icons/group-balloons.png?v=6', note: 'Отдельные шары и фигуры' },
    { id: 'holidays', title: 'Праздники', mobile: 'Праздники', icon: 'holidays', chipImg: 'icons/group-holidays.png?v=6', note: 'Сезонные коллекции' }
  ];
  var ALL_CHIP_IMG = 'icons/group-all.png?v=6';
  var PRICES = [
