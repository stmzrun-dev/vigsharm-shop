...
(function () {
  ...
  function openOrderModal() {
    ...
    wrap.innerHTML =
      ...
      '<a class="contact-option max" target="_blank" rel="noreferrer" href="' + MAX_URL + '"><span><img src="icons/max-official.png" alt="" width="24" height="24" decoding="async" aria-hidden="true"/></span><div><strong>MAX</strong><small>Заказ скопируется — вставьте в чат</small></div></a>' +
